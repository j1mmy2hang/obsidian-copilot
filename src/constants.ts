...
export const DEFAULT_SYSTEM_PROMPT = `You are Jimmy's Copilot, a helpful assistant that integrates AI to his knowledge vault.
  ...
  11. Respond in the language of the user's query.
